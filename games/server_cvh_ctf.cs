// FILENAME: server_CVH_CTF.cs
//
//Cybrid vs. Human with Unlimited Tech Level & No mixing
...
//-------------------------------------------------
//$server::Hostname =                                strcat($Location, ": CTF CvH");
...
// or time limits set.
//-------------------------------------------------
$MissionCycling::Stage0 =                           "CTF_Titanic_Assault";
$MissionCycling::Stage1 =                           "CTF_stab_n_grab";
...
function setAllowedItems()
{
	...
	allowVehicle(                                           10, FALSE  );      //Knight's Apocalypse
