// FILENAME: server_CTF_BIG.cs
//
//CTF server with only big hercs
...
//-------------------------------------------------
//$server::Hostname =                                strcat($Location, ": Big CTF");
...
function setAllowedItems()
{
	...
	allowVehicle(                                            4, FALSE  );      //Terran Talon
	allowVehicle(                                           13, FALSE  );      //Knight's Talon
	allowVehicle(                                            2, FALSE  );      //Terran Minotaur
	allowVehicle(                                           11, FALSE  );      //Knight's Minotaur
